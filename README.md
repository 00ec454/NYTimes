# Project 2 - *CodePath Week-2 Assignment: NYTimes*

**Name of your NyTimes is an android app that allows a user to search for articles on web using simple filters. The app utilizes [New York Times Search API](http://developer.nytimes.com/docs/read/article_search_api_v2).
...
<img src='https://i.imgur.com/VU3fRqH.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
